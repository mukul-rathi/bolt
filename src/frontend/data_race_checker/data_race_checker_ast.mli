...
type expr =
  ...
  | FinishAsync of
      ...
      (** overall type is that of the expr on the current thread - since forked exprs'
          values are ignored. [(Var_name.t * Class_name.t) list] is a list of free object
          variables in the block expression and their associated types *)
...
(** Async exprs have a precomputed list of their free object variables and their
    associated classes (passed as arguments when they are spawned as thread) *)
