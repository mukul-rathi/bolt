...
val type_function_reverse_borrowing :
  ...
  -> block_expr
  -> unit Or_error.t
(** Checks the function return type [type_expr] , whether it returns borrowed refernce
    [borrowed_ref option] and the [block_expr] body expression to check reverse borrowing.
    [string] is the error prefix *)
