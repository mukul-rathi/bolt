...
val type_overloaded_function_defns : Parsed_ast.function_defn list -> unit Or_error.t
(** Check functions are overloaded correctly (i.e. each has a different number/type of
    args) *)

val type_overloaded_method_defns : Parsed_ast.method_defn list -> unit Or_error.t
